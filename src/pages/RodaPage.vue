<template>
  ...
  <div class="q-pa-md">
    ...
    <q-list padding bordered class="rounded-borders">
      <!-- Beijo da Primavera -->
      <q-expansion-item dense dense-toggle expand-separator label="Beijo da Primavera" header-class="text-primary">
        <q-card>
    ...
    <q-list padding bordered class="rounded-borders">
      ...
      <!-- Cadê a Floresta? -->
      <q-expansion-item dense dense-toggle expand-separator label="Cadê a Floresta?" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            ...
            <p>Nossas vertentes belezas</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; F
            </p>
            <p>Os peixes da piracema</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; A#
            </p>
            <p>Não tem mais essa riqueza</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp;&nbsp;Cm
            </p>
    ...
    <q-list padding bordered class="rounded-borders">
      ...
      <q-expansion-item dense dense-toggle expand-separator label="Lôa" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            ...
            <br>
            <p>Não cansa de me chamar</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; F7
            </p>
            <p>Remo de faia canoa</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Cm
            </p>
      ...
      <!-- Pescaria -->
      <q-expansion-item dense dense-toggle expand-separator label="Pescaria" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            <p class="autor">Mestre Cardoso</p>
    ...
    <q-list padding bordered class="rounded-borders">
      ...
      <q-expansion-item dense dense-toggle expand-separator label="Vós Sois o Lírio Mimoso" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            <p class="vermelho">
              F &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <p class="text-body1">Samba de cacete</p>
    <q-list padding bordered class="rounded-borders">
      <!-- Peixe Voador -->
      <q-expansion-item dense dense-toggle expand-separator label="Peixe Voador" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            ...
            <p>eu quero saber quem foi</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; C
            </p>
            <p>que mandou essa ribeira</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; F
            </p>
            <p>pra brincar no peixe-boi</p>
            <p>Foi a sereia do mar</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; G
            </p>
            <p>não foi, não foi</p>
            ...
            <p>Foi o peixe voador</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; F
            </p>
            <p>não foi, não foi</p>
            <p>Foi estrela matutina</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; G
            </p>
            <p>nessa noite de luar</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; C
            </p>
            <p>que mandou essa menina</p>
            <p class="vermelho">
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; F
            </p>
            <p>ver a onda balançar</p>
            ...
            <p>vem voando, vem voando</p>
            <p>luar, luar</p>
            <p class="vermelho">
              C &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; F
            </p>
            <p>navegando e marujando</p>
          </q-card-section>
        </q-card>
      </q-expansion-item>
    </q-list>
    <p class="text-body1">Xote</p>
    <q-list padding bordered class="rounded-borders">
      <!-- Ataiô -->
      ...
      <!-- Relva -->
      <q-expansion-item dense dense-toggle expand-separator label="Relva" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            <p class="autor">Allan Carvalho e Ronaldo Silva</p>
            <p class="vermelho">Gm</p>
            ...
            <p class="vermelho">Gm</p>
            <p>A mesma alegria que tinhas no olhar</p>
          </q-card-section>
        </q-card>
      </q-expansion-item>
      <!-- Domingo de Tartde -->
      <q-expansion-item dense dense-toggle expand-separator label="Domingo de Tartde" header-class="text-primary">
        <q-card>
          <q-card-section class="q-pt-none">
            ...
            <p>Voa bem-te-vi &nbsp; Voa pra avisar</p>
            <p class="vermelho">
              D &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp;&nbsp; &nbsp; &nbsp; A &nbsp; E &nbsp; &nbsp; &nbsp; &nbsp; F#m
            </p>
            <p>Cante, conte pra ela, passarinho</p>
            <p class="vermelho">
              D&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; E &nbsp;
              &nbsp; &nbsp; &nbsp;A
            </p>
