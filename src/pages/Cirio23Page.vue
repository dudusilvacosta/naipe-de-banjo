<template>
  ...
  <div class="q-pa-md">
    <q-breadcrumbs class="q-mb-sm">
      ...
      <q-breadcrumbs-el label="Círio 2023" />
    </q-breadcrumbs>
    <div class="row justify-center q-gutter-sm">
      <q-intersection class="example-item" @click="card10 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/10.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card9 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/9.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card8 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/8.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card7 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/7.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card6 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/6.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card5 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/5.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card4 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/4.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card3 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-23/3.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
