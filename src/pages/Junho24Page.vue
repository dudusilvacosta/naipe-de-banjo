    ...
    <div class="row justify-center q-gutter-sm">
      <q-intersection class="example-item" @click="card10 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/10.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card9 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/9.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card8 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/8.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card7 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/7.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card6 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/6.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card5 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/5.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card4 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/4.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card3 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/junho-24/3.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
