<template>
  ...
  <div class="q-pa-md">
    <q-breadcrumbs class="q-mb-sm">
      ...
      <q-breadcrumbs-el label="Outubro 2025" />
    </q-breadcrumbs>
    <div class="row justify-center q-gutter-sm">
      ...
      <q-intersection class="example-item" @click="card8 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/8.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card7 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/7.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card6 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/6.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card5 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/5.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card4 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/4.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card3 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/3.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card2 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/2.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
      ...
      <q-intersection class="example-item" @click="card1 = true">
        <q-card flat bordered>
          <img
            src="https://github.com/dudusilvacosta/fotos-naipe-banjo/blob/main/cirio-25/1.jpeg?raw=true"
          />
        </q-card>
      </q-intersection>
